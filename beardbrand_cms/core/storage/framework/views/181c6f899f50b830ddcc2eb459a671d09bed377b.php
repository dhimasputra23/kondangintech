...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/kondangintech-landing/img/favicon.png" rel="icon">
...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        <img src="assets/kondangintech-landing/img/kondangin2.png" alt="">
        <!-- <span>FlexStart</span> -->
      </a>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a id="whatsappButton5" class="getstarted scrollto" href="#">Hubungi Kami <i class="fab fa-whatsapp"></i></a></li>
        </ul>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/kondangintech-landing/img/blog/blog-1.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/kondangintech-landing/img/blog/blog-2.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/kondangintech-landing/img/blog/blog-3.jpg" alt="" class="img-fluid">
              </div>
            ...
            <article class="entry">
              ...
              <div class="entry-img">
                <img src="assets/kondangintech-landing/img/blog/blog-4.jpg" alt="" class="img-fluid">
              </div>
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item recent-posts">
                <div class="post-item clearfix">
                  <img src="assets/kondangintech-landing/img/blog/blog-recent-1.jpg" alt="">
                  <h4><a href="blog-single.html">Nihil blanditiis at in nihil autem</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/kondangintech-landing/img/blog/blog-recent-2.jpg" alt="">
                  <h4><a href="blog-single.html">Quidem autem et impedit</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/kondangintech-landing/img/blog/blog-recent-3.jpg" alt="">
                  <h4><a href="blog-single.html">Id quia et et ut maxime similique occaecati ut</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/kondangintech-landing/img/blog/blog-recent-4.jpg" alt="">
                  <h4><a href="blog-single.html">Laborum corporis quo dara net para</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="assets/kondangintech-landing/img/blog/blog-recent-5.jpg" alt="">
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Penyedia solusi digital terkemuka untuk pembuatan dan pengembangan website. Sebagai pionir teknologi, kami membawa pengalaman bertahun-tahun dalam merancang platform online inovatif.</p>
            <div class="social-links mt-3">
             
              <a target="_blank" href="https://www.instagram.com/kontech.official/" class="instagram"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            <h4>Contact Us</h4>
            <p>
              Jl. AMD Raya RT 03 RW 01 No.105 <br>
              Pd. Kacang Barat, Kec. Pd. Aren <br> 
              Kota Tangerang Selatan, Banten 15226 <br><br>
           
              <strong>Phone 1:</strong> 6285326413810<br>
              <strong>Phone 2:</strong> 6289679048560<br>
              <strong>Email:</strong> admin@kondangin.org<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>KONTECH</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
  ...
  <script>
    ...
    document.getElementById('whatsappButton5').href = getRandomWhatsAppNumber();
    document.getElementById('whatsappButton6').href = getRandomWhatsAppNumber();
    </script>
...
</html><?php /**PATH C:\xampp-portable-windows-x64-7.4.33-0-VC15\xampp\htdocs\cms-bearbrand\core\resources\views/kondangintech-landing/blog.blade.php ENDPATH**/ ?>