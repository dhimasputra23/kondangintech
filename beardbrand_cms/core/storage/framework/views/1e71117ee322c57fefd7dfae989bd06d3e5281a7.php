                    ...
                    <table class="table table-striped table-bordered data_table">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('Start Price')); ?></th>
                                <th><?php echo e(__('End Price')); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo e(Helper::showCurrency()); ?><?php echo e(number_format($package->price, 0, ',', '.')); ?>

                                    <?php else: ?> 
                                    <span class="badge badge-info"><?php echo e(__('No Price')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($package->discount_price): ?>
                                    <?php echo e(Helper::showCurrency()); ?><?php echo e(number_format($package->discount_price, 0, ',', '.')); ?>
                                ...
                                <td>
                                    <?php if($package->start_price): ?>
                                    <?php echo e(Helper::showCurrency()); ?><?php echo e(number_format($package->start_price, 0, ',', '.')); ?>

                                    <?php else: ?> 
                                    <span class="badge badge-info"><?php echo e(__('No Start Price')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if($package->end_price): ?>
                                    <?php echo e(Helper::showCurrency()); ?><?php echo e(number_format($package->end_price, 0, ',', '.')); ?>

                                    <?php else: ?> 
                                    <span class="badge badge-info"><?php echo e(__('No End Price')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <img src="<?php echo e(asset('assets/kondangintech-landing/img/'.$package->image)); ?>"   alt="" width="60">
                                </td>
                                <td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-portable-windows-x64-7.4.33-0-VC15\xampp\htdocs\cms-bearbrand\core\resources\views/admin/package/index.blade.php ENDPATH**/ ?>