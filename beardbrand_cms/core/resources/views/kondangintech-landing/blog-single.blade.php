...
<head>
  ...
  <title>Blog Single - KONTECH</title>
...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a id="whatsappButton3" target="_blank" class="getstarted scrollto" href="#about">Hubungi Kami <i class="fab fa-whatsapp"></i></a></li>
        </ul>
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-content">
                ...
                <img src="assets/kondangintech-landing/img/blog/blog-inside-post.jpg" class="img-fluid" alt="">
            ...
            <div class="blog-author d-flex align-items-center">
              <img src="assets/kondangintech-landing/img/blog/blog-author.jpg" class="rounded-circle float-left" alt="">
              <div>
                <h4>Jane Smith</h4>
  ...
  <script>
    ...
    document.getElementById('whatsappButton3').href = getRandomWhatsAppNumber();
    document.getElementById('whatsappButton4').href = getRandomWhatsAppNumber();
    </script>
