...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::get('/blog/category/{category}', 'Front\FrontendController@blogsCategory')->name('front.blogsCategory');
    Route::get('/blog-details/{slug}', 'Front\FrontendController@blogdetails')->name('front.blogdetails');
    Route::get('/portfolio-details/{slug}', 'Front\FrontendController@portfoliodetails')->name('front.portfoliodetails');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin']], function () {
    ...
    Route::get('/portfolio/portfolio-category', 'Admin\PortfoliocategoryController@portfoliocategory')->name('admin.portfoliocategory');
    Route::get('/portfolio/portfolio-category/add', 'Admin\PortfoliocategoryController@add')->name('admin.portfoliocategory.add');
    Route::post('/portfolio/portfolio-category/store', 'Admin\PortfoliocategoryController@store')->name('admin.portfoliocategory.store');
    Route::post('/portfolio/portfolio-category/delete/{id}/', 'Admin\PortfoliocategoryController@delete')->name('admin.portfoliocategory.delete');
    Route::get('/portfolio/portfolio-category/edit/{id}/', 'Admin\PortfoliocategoryController@edit')->name('admin.portfoliocategory.edit');
    Route::post('/portfolio/portfolio-category/update/{id}/', 'Admin\PortfoliocategoryController@update')->name('admin.portfoliocategory.update');
    ...
    Route::post('/portfolio/portfoliocontent/{id}/', 'Admin\PortfolioController@portfoliocontent')->name('admin.portfoliocontent.update');
