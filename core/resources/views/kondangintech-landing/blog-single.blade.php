          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-footer">
                ...
                <ul class="cats">
                  <li><a href="#">{{ $blog->bcategory->name }}</a></li>
                </ul>
            ...
            <div class="blog-author d-flex align-items-center">
              <img src="{{ asset('assets/kondangintech-landing/img/'.$commonsetting->company_logo) }}" class="rounded-circle float-left" alt="">
              <div>
