          ...
          @endif">
            ...
            @endif">
              ...
              @endif">
                ...
                <li class="nav-item has-treeview
              @if(request()->path() == 'admin/portfolio') menu-open
              @elseif(request()->path() == 'admin/portfolio/portfolio-category') menu-open
              @elseif(request()->path() == 'admin/portfolio/portfolio-category/add') menu-open
              @elseif(request()->path() == 'admin/portfolio/add') menu-open
              @elseif(request()->path() == 'admin/archives') menu-open
              @elseif(request()->path() == 'admin/archive/edit') menu-open
              @elseif(request()->path() == 'admin/archive/add') menu-open
              @elseif(request()->is('admin/portfolio/portfolio-category/edit/*')) menu-open
              @elseif(request()->is('admin/portfolio/edit/*')) menu-open
              @endif">
                    <a href="#" class="nav-link
                @if(request()->path() == 'admin/portfolio') active
                @elseif(request()->path() == 'admin/portfolio/portfolio-category') active
                @elseif(request()->path() == 'admin/portfolio/portfolio-category/add') active
                @elseif(request()->path() == 'admin/portfolio/add') active
                @elseif(request()->path() == 'admin/archives') active
                @elseif(request()->path() == 'admin/archive/edit') active
                @elseif(request()->path() == 'admin/archive/add') active
                @elseif(request()->is('admin/portfolio/portfolio-category/edit/*')) active
                ...
                @endif">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.portfoliocategory'). '?language=' . $lang_code }}" class="nav-link
                  @if(request()->path() == 'admin/portfolio/portfolio-category') active 
                  @elseif(request()->path() == 'admin/portfolio/portfolio-category/add') active
                  @elseif(request()->is('admin/portfolio/portfolio-category/edit/*')) active 
                  @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('Portfolio Categories') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.portfolio'). '?language=' . $lang_code }}" class="nav-link
                  @if(request()->path() == 'admin/portfolio') active 
                  @elseif(request()->path() == 'admin/portfolio/add') active
                  @elseif(request()->is('admin/portfolio/edit/*')) active
                  @endif">
