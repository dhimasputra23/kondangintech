                                ...
                                <form class="form-horizontal" action="{{ route('admin.portfolio.store') }}" method="POST" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="project_url" placeholder="{{ __('Project URL') }}" value="{{ old('project_url') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group date" id="datepicker">
                                                <input type="date" class="form-control" name="project_date" placeholder="{{ __('Project Date') }}" value="{{ old('project_date') }}">
