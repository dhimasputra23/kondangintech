                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.package.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="start_price" placeholder="{{ __('Start Price') }}" value="{{ old('start_price') }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="end_price" placeholder="{{ __('End Price') }}" value="{{ old('end_price') }}">
