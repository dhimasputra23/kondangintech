                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="mw-400 mb-3 show-img img-demo" src="{{ asset('assets/kondangintech-landing/img/'.$blog->main_image) }}" alt="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" data-role="tagsinput" name="tags" placeholder="{{ __('Enter Tags') }}" value="{{ $blog->tags }}">
                                            @if ($errors->has('tags'))
