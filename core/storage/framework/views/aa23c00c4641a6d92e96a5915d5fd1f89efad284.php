...
<aside class="main-sidebar elevation-4 main-sidebar elevation-4 sidebar-light-primary">
    ...
    <div class="sidebar pt-0 mt-0">
        ...
        <div class="user-panel">
            <a href="<?php echo e(route('front.index')); ?>" class="name text-dark" target="_blank" style="padding-left: 0px;text-align: center">
                <img src="<?php echo e(asset('assets/kondangintech-landing/img/'.$commonsetting->header_logo)); ?>" alt="">
            </a>
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
        ...
        <?php endif; ?>">
          ...
          <?php endif; ?>">
            ...
            -->
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.hero'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/hero'): ?> active
            ...
            <?php endif; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.value'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/value'): ?> active
            <?php elseif(request()->path() == 'admin/value/add'): ?> active
            <?php elseif(request()->is('admin/about/value/*')): ?> active
            <?php endif; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.feature1'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/feature-1'): ?> active
            <?php elseif(request()->is('admin/about/feature-1/*')): ?> active
            <?php endif; ?>">
                        <i class="nav-icon fas fa-laptop-code"></i>
                        <p>
                            <?php echo e(__('Feature-1')); ?>

                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.feature2'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/feature-2'): ?> active
            <?php elseif(request()->path() == 'admin/feature-2/add'): ?> active
            <?php elseif(request()->is('admin/about/feature-2/*')): ?> active
            <?php endif; ?>">
                        <i class="nav-icon fas fa-laptop-code"></i>
                        <p>
                            <?php echo e(__('Feature-2')); ?>

                        </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.feature3'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/feature-3'): ?> active
            <?php elseif(request()->path() == 'admin/feature-3/add'): ?> active
            <?php elseif(request()->is('admin/about/feature-3/*')): ?> active
            <?php endif; ?>">
                        <i class="nav-icon fas fa-laptop-code"></i>
                        <p>
                            <?php echo e(__('Feature-3')); ?>
            ...
            <?php endif; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.clients'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/clients'): ?> active
            <?php elseif(request()->path() == 'admin/clients/add'): ?> active
            <?php elseif(request()->is('admin/clients/edit/*')): ?> active
            <?php endif; ?>">
            ...
            <?php endif; ?>">
              ...
              <?php endif; ?>">
                ...
                <li class="nav-item has-treeview
              <?php if(request()->path() == 'admin/portfolio'): ?> menu-open
              <?php elseif(request()->path() == 'admin/portfolio/portfolio-category'): ?> menu-open
              <?php elseif(request()->path() == 'admin/portfolio/portfolio-category/add'): ?> menu-open
              <?php elseif(request()->path() == 'admin/portfolio/add'): ?> menu-open
              <?php elseif(request()->path() == 'admin/archives'): ?> menu-open
              <?php elseif(request()->path() == 'admin/archive/edit'): ?> menu-open
              <?php elseif(request()->path() == 'admin/archive/add'): ?> menu-open
              <?php elseif(request()->is('admin/portfolio/portfolio-category/edit/*')): ?> menu-open
              <?php elseif(request()->is('admin/portfolio/edit/*')): ?> menu-open
              <?php endif; ?>">
                    <a href="#" class="nav-link
                <?php if(request()->path() == 'admin/portfolio'): ?> active
                <?php elseif(request()->path() == 'admin/portfolio/portfolio-category'): ?> active
                <?php elseif(request()->path() == 'admin/portfolio/portfolio-category/add'): ?> active
                <?php elseif(request()->path() == 'admin/portfolio/add'): ?> active
                <?php elseif(request()->path() == 'admin/archives'): ?> active
                <?php elseif(request()->path() == 'admin/archive/edit'): ?> active
                <?php elseif(request()->path() == 'admin/archive/add'): ?> active
                <?php elseif(request()->is('admin/portfolio/portfolio-category/edit/*')): ?> active
                ...
                <?php endif; ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.portfoliocategory'). '?language=' . $lang_code); ?>" class="nav-link
                  <?php if(request()->path() == 'admin/portfolio/portfolio-category'): ?> active 
                  <?php elseif(request()->path() == 'admin/portfolio/portfolio-category/add'): ?> active
                  <?php elseif(request()->is('admin/portfolio/portfolio-category/edit/*')): ?> active 
                  <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Portfolio Categories')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.portfolio'). '?language=' . $lang_code); ?>" class="nav-link
                  <?php if(request()->path() == 'admin/portfolio'): ?> active 
                  <?php elseif(request()->path() == 'admin/portfolio/add'): ?> active
                  <?php elseif(request()->is('admin/portfolio/edit/*')): ?> active
                  <?php endif; ?>">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp-portable-windows-x64-7.4.33-0-VC15\xampp\htdocs\cms-bearbrand\core\resources\views/admin/partials/side-navbar.blade.php ENDPATH**/ ?>