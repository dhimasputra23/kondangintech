                        ...
                        <form class="form-horizontal" action="<?php echo e(route('admin.testimonialcontent.update',  $saectiontitle->language_id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php echo e(asset('assets/kondangintech-landing/img/'.$saectiontitle->testimonial_bg)); ?>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <table class="table table-striped table-bordered data_table">
                        ...
                        <tr>
                            <td><?php echo e(++$id); ?></td>
                            <td>
                                <img class="w-80" src="<?php echo e(asset('assets/kondangintech-landing/img/'.$testimonial->image)); ?>" alt="">
                            </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-portable-windows-x64-7.4.33-0-VC15\xampp\htdocs\cms-bearbrand\core\resources\views/admin/testimonial/index.blade.php ENDPATH**/ ?>