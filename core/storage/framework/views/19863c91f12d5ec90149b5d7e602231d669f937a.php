        ...
        <div class="row">
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.package.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="discount_price" placeholder="<?php echo e(__('Discount Price')); ?>" value="<?php echo e(old('discount_price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="start_price" placeholder="<?php echo e(__('Start Price')); ?>" value="<?php echo e(old('start_price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" class="form-control" name="end_price" placeholder="<?php echo e(__('End Price')); ?>" value="<?php echo e(old('end_price')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="feature" class="form-control" data-role="tagsinput" placeholder="<?php echo e(__('Feature')); ?>" value="<?php echo e(old('feature')); ?>" >
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-portable-windows-x64-7.4.33-0-VC15\xampp\htdocs\cms-bearbrand\core\resources\views/admin/package/add.blade.php ENDPATH**/ ?>