...
<head>
	...
	<link href="<?php echo e(asset('assets/kondangintech-landing/img/apple-touch-icon.png')); ?>" rel="apple-touch-icon">
	...
	<!-- Vendor CSS Files -->
	<link href="<?php echo e(asset('assets/kondangintech-landing/vendor/aos/aos.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/kondangintech-landing/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/kondangintech-landing/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/kondangintech-landing/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/kondangintech-landing/vendor/remixicon/remixicon.css')); ?>" rel="stylesheet">
	<link href="<?php echo e(asset('assets/kondangintech-landing/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">
	...
	<link href="<?php echo e(asset('assets/kondangintech-landing/css/style.css')); ?>" rel="stylesheet">
...
<body <?php echo e(Session::has('notification') ? 'data-notification' : ''); ?> <?php if(Session::has('notification')): ?> data-notification-message='<?php echo e(json_encode(Session::get('notification'))); ?> <?php endif; ?>' >
	...
	<!-- Vendor JS Files -->
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/purecounter/purecounter_vanilla.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/aos/aos.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/glightbox/js/glightbox.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
	<script src="<?php echo e(asset('assets/kondangintech-landing/vendor/php-email-form/validate.js')); ?>"></script>
  
	<!-- Template Main JS File -->
	<script src="<?php echo e(asset('assets/kondangintech-landing/js/main.js')); ?>"></script>
	<script>
