                                ...
                                <form class="form-horizontal" action="<?php echo e(route('admin.portfolio.store')); ?>" method="POST" enctype="multipart/form-data">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="project_url" placeholder="<?php echo e(__('Project URL')); ?>" value="<?php echo e(old('project_url')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group date" id="datepicker">
                                                <input type="date" class="form-control" name="project_date" placeholder="<?php echo e(__('Project Date')); ?>" value="<?php echo e(old('project_date')); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-portable-windows-x64-7.4.33-0-VC15\xampp\htdocs\cms-bearbrand\core\resources\views/admin/portfolio/add.blade.php ENDPATH**/ ?>