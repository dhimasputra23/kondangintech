...
//    Route::get('/checkout/mollie/notify', 'Front\CheckoutController@mollieRedirect')->name('front.checkout.mollie.redirect');
    ...
    Route::get('/product/order/cancle', 'Payment\Product\PaypalController@paycancle')->name('product.payment.cancle');
    Route::get('/product/order/success', 'Payment\Product\PaypalController@payreturn')->name('product.payment.return');
    ...
    Route::get('/stripe/payment/redirect', 'Payment\Product\StripeController@paymentRedirect')->name('stripe.payment.redirect');
...
// Checkout redirect
Route::get('/checkout/redirect',  [\App\Http\Controllers\Payment\Product\CheckoutController::class, 'paymentRedirect'])->name('front.checkout.redirect');